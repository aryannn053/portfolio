  ...
  return (
    <div className="mx-auto px-14 md:max-w-lg lg:max-w-4xl">
      ...
      <section id="experience">
        <div className="pt-12">
          ...
          <div className="pt-1">
            <div className="experience-flex">
              <img
                src="https://media.licdn.com/dms/image/v2/D560BAQFj-7E-eQe8KA/company-logo_100_100/company-logo_100_100/0/1721544337699/designmentorweb_logo?e=1744243200&v=beta&t=dQ4t2spK-9OzxnjmfJ2LBfDjy6RpCJy9zG2kd8JHQ-8"
                className="rounded-full grayscale hover:grayscale-0"
                width="50"
                height="50"
              />
      ...
      <section id="projects">
        ...
        <div className="flexbox-grid-c flexbox-grid-c-cols-2 gap-0 pb-12">
          <div>
            <h1 className="wahre">• Dictionary App</h1>
            <p className="whytho pt-1 text-gray-600">
              A simple dictionary app that is written in Next JS which uses the Wiktionary API for information of a word.
            </p>

            <div className="flexbox-grid-c flexbox-grid-c-cols-2">
              <a href="https://arytionary.vercel.app" className="wahatag pt-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="ionicon s-ion-icon"
                  viewBox="0 0 512 512"
              ...
              <a
                href="https://github.com/aryannn053/dictionary"
                className="wahatag pt-4"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="px-10">
            <img
              src="https://pbs.twimg.com/media/Gg0YY3laMAAlrwr?format=png&name=900x900"
              className="rounded grayscale hover:grayscale-0 pro-image"
              width="400"
            />
          </div>
